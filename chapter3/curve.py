...
print('Length of closed contour is %.2f' %cv2.arcLength(contour,False))
...
print('Convex status of contour is %s' %cv2.isContourConvex)
...
cv2.createTrackbar('Epsilon','contours',1,255,lambda v: tracker_callback(v))
while True:
